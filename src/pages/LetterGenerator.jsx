              ...
              <form onSubmit={handleGenerate} className="space-y-4 flex-1">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl font-bold text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#002F45] focus:bg-white transition-all appearance-none"
                  >
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl font-medium focus:outline-none focus:ring-2 focus:ring-[#002F45] focus:bg-white transition-all resize-none"
                  />
                </div>
                ...
                <div className="pt-4 mt-auto">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 bg-[#002F45] text-white font-bold rounded-2xl hover:bg-[#001a26] transition-colors active:scale-95 shadow-md flex items-center justify-center gap-2 disabled:opacity-70 disabled:active:scale-100"
                  >
            ...
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 flex-1 flex flex-col overflow-hidden">
              ...
              <div className="flex justify-between items-center p-4 md:p-6 border-b border-gray-100 bg-white">
                ...
                {generatedLetter && (
                  <button 
                    onClick={handleCopy}
                    className="flex items-center gap-2 px-4 py-2 bg-gray-50 text-[#002F45] border border-gray-200 rounded-xl text-sm font-bold hover:bg-gray-100 transition-colors active:scale-95"
                  >
