  ...
  return (
    <div className="w-full">
      ...
      {showRestartModal && createPortal(
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[99999] flex flex-col justify-end md:justify-center items-center p-0 md:p-4" onClick={() => setShowRestartModal(false)}>
          <div className="bg-white dark:bg-gray-900 rounded-t-[2rem] md:rounded-3xl p-6 w-full md:max-w-sm border border-gray-100 dark:border-gray-700 shadow-2xl max-h-[92vh] overflow-y-auto animate-in slide-in-from-bottom duration-300 md:animate-none" onClick={e => e.stopPropagation()}>
