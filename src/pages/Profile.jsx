        ...
        <div className="max-w-3xl mx-auto px-6 pt-[calc(3rem_+_env(safe-area-inset-top,0px))] space-y-8">
          ...
          <div onClick={() => navigate('/support')}
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-gray-500 max-w-[200px] leading-relaxed mb-3">Help us keep this app free and growing for all students.</p>
              <span className="inline-block bg-gray-900 text-white text-xs font-bold px-4 py-2 rounded-lg shadow-sm">Read Our Story</span>
            </div>
