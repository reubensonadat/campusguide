/**
 * CampusMapData.js
 * Pure data file — no React/JSX. Safe to import from services.
 * Contains all UCC campus buildings, coordinate helpers, and map defaults.
 */
...
export const getCoordinates = (url) => {
  ...
  if (coordMatch) {
    return [parseFloat(coordMatch[1]), parseFloat(coordMatch[3])]; // [lat, lng]
  }
  return null;
};

export const openGoogleMaps = (term) => {
...
export const defaultCenter = [5.116774, -1.290948]; // Sam Jonah Library — geographic center of New Site
