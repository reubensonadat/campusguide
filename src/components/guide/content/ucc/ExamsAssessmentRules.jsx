          ...
          <div className="bg-slate-900 text-slate-100 p-8 md:p-12 rounded-[3rem] shadow-2xl relative overflow-hidden">
             ...
             <div className="relative space-y-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-700 pb-8">
                   ...
                   <div className="bg-primary-500/20 text-primary-300 px-4 py-2 rounded-2xl border border-primary-500/30 text-sm font-black uppercase tracking-widest">
                      ∑ Calculation
                   </div>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-10">
                   <div className="space-y-6">
                      <div className="bg-slate-800/50 p-6 rounded-3xl border border-slate-700">
                         <h5 className="text-primary-400 font-black text-sm uppercase mb-4 tracking-widest">Key Definitions</h5>
                      ...
                      <div className="bg-primary-500/10 p-6 rounded-3xl border border-primary-500/20">
                   ...
                   <div className="bg-white rounded-[2rem] p-8 text-slate-900 shadow-xl">
                      ...
                      <div className="space-y-3 mb-8">
                         <ExampleRow code="ECO 101" credits="3" grade="B" gp="9" color="bg-primary-50 text-primary-700" />
                      ...
                      <div className="border-t-2 border-slate-100 pt-4 flex flex-col items-end gap-1">
                         ...
                         <div className="mt-4 bg-primary-600 text-white px-6 py-3 rounded-2xl w-full text-center">
