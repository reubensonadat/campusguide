      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* SECURITY SERVICE */}
            <div className="bg-blue-50 dark:bg-blue-900/40 p-5 rounded-xl border border-blue-100 dark:border-blue-800/50 flex items-start gap-4">
              <div className="bg-blue-100 dark:bg-blue-900/40 p-3 rounded-full text-blue-600">
                <Shield size={24} />
              </div>
              <div>
                <h4 className="font-bold text-blue-900 dark:text-blue-400 text-lg">UCC Security Service</h4>
                <p className="text-sm text-blue-800 dark:text-blue-300 mb-2">24/7 Campus Patrol</p>
          ...
          <div className="pt-4">
            <h3 className="font-bold text-gray-800 dark:text-gray-200 text-xl mb-4">SRC Support Team</h3>
            <div className="bg-white dark:bg-gray-800/60 border border-gray-200 rounded-xl divide-y divide-gray-100 shadow-sm overflow-hidden">
