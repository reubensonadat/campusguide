...
const CampusMap = () => {
  ...
  const buildings = [
    ...
    { id: "A23", fullName: "SRT", shortForm: "SRT", description: "New Site.", url: " 5.11676647092683, -1.293229663589804" },
    ...
    //  { id: "T5", fullName: "SRC Hall Taxi Rank", shortForm: "SRC Rank", description: "Serves SRC/GUSSS.", url: "SRC Hall UCC" },
