...
const now = new Date();
export const TODAY_NAME = DAYS[now.getDay()];
export const TODAY_LABEL = `${DAYS[now.getDay()]}, ${MONTHS[now.getMonth()]} ${now.getDate()}`;
...
export const getISODate = (d) => d.toISOString().split('T')[0];
export const getWeekId = (d) => {
