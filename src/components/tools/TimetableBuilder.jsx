            ...
            <div className="flex w-full sm:w-auto gap-2 flex-wrap">
              {!notificationsEnabled && isNotificationSupported() && (
                <Button
                  ...
                  className="flex-1 sm:flex-none border-gray-900/20 text-gray-900 hover:bg-gray-900/5"
                >
              ...
              <Button
                ...
                className="flex-1 sm:flex-none bg-gray-900 hover:bg-gray-900 text-white shadow-md hover:shadow-lg transition-all"
              >
          ...
          <div ref={timetableRef} className="px-1 py-4 md:p-6 bg-slate-50/50 rounded-2xl">
            {displayCourses.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-3xl border border-dashed border-gray-200">
                ...
                <Button onClick={() => setShowAddForm(true)} className="bg-gray-900 text-white hover:bg-gray-900 shadow-md">
                ...
                {selectedCourse.creditHours && (
                  <div className="flex items-center gap-4 bg-gray-900/5 p-3.5 rounded-2xl border border-gray-900/10 hover:bg-gray-900/10 transition-colors group">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="font-black text-gray-900">{selectedCourse.creditHours} Credit Hours</span>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="space-y-6">
            <div className="p-5 bg-gradient-to-r from-gray-900/10 to-primary-50 rounded-2xl border border-gray-900/10">
              ...
              <div className="flex gap-2 mt-3">
                <span className="text-xs font-bold bg-gray-900/10 text-gray-900 px-3 py-1 rounded-full uppercase tracking-wider">
                ...
                {sharedTimetable.courses.map((course, idx) => (
                  ...
                  >
                    <input
                      ...
                      className="w-4.5 h-4.5 text-gray-900 border-gray-300 rounded focus:ring-gray-900"
                    />
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 bg-gray-900 hover:bg-gray-900 text-white py-3.5 rounded-xl font-bold transition-all shadow-md active:scale-95"
              >
                Import Selected
              </button>
            </div>
